...
##csvFile_Loc = open('list_ent_ny.csv', 'w',newline='')
...
##csvFile_Loc = open('list_mng_ny.csv', 'w',newline='')
##csvWriter = csv.writer(csvFile_Loc,delimiter=';', quotechar='"', quoting=csv.QUOTE_MINIMAL)
##csvWriter.writerow(["user_screen_name",
##                    "user_name",
##                    "user_id",
...
tweets = tweepy.Cursor(api.search,
                       ...
                       lang='en',
                       tweet_mode="extended",
                       geocode="40.712776,-74.005974,20km"
                       ).items()
...
#                print("mng")
        ...
        if (is_ent == 1) and (is_mng == 0):
            n_ent +=1
            print("ent")
            csvFile_Loc = open('list_ent_ny.csv', 'a',encoding="utf-8",newline='')
        ...
        if (is_ent == 0) and (is_mng == 1):
            n_mng +=1
            print("mng")
            csvFile_Loc = open('list_mng_ny.csv', 'a',encoding="utf-8",newline='')
            csvWriter = csv.writer(csvFile_Loc, delimiter=';' , quoting=csv.QUOTE_MINIMAL)
            csvWriter.writerow([tweet.user.screen_name.translate(non_bmp_map),
                               tweet.user.name.translate(non_bmp_map),
                               tweet.user.id,
